...
author:         Xian Lee
date:           2012-6-27
description:    c = sqrt(a^2 + b^2), excute time:12us, accuracy:1
*/
...
author:         Xian Lee
date:           2012-6-29
description:    extract an uint32 value, excute time:24-29us, accuracy:1
*/
uint16 Sqrt32(uint32 x)
{   
    uint32 squ_v[] = {0x1000000,0x4000000,0x9000000,0x10000000,0x19000000,0x24000000,0x31000000,0x40000000,0x51000000,0x64000000,0x79000000,0x90000000,0xa9000000,0xc4000000,0xe1000000};
    uint16 root[] = {0x1000,0x2000,0x3000,0x4000,0x5000,0x6000,0x7000,0x8000,0x9000,0xa000,0xb000,0xc000,0xd000,0xe000,0xf000};
...
author:         Xian Lee
date:           2012-6-29
description:    extract an uint16 value, excute time:18-22us, accuracy:1
*/
uint8 Sqrt16(uint16 x)
{   
    uint16 squ_v[] = {0x400,0x1000,0x2400,0x4000,0x6400,0x9000,0xc400};
    uint8 root[] = {0x20,0x40,0x60,0x80,0xa0,0xc0,0xe0};
...
author:         Xian Lee
date:           2012-7-1
description:    y = arctan(x), excute time:44-55us, accuracy:0.1 degree
*/
float tan[] = {
...
author:         Xian Lee
date:           2012-7-1
description:    y = sin(x), excute time:29-34us, accuracy:0.01
*/
float sin[] = 
{
...
author:         Xian Lee
date:           2012-7-1
description:    y = x^n, excute time:14*ln(n+1)
*/
